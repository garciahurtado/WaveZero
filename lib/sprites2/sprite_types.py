...
SPRITE_BARRIER_LEFT_x2 = const(2)
SPRITE_BARRIER_RIGHT = const(3)
SPRITE_BARRIER_RED = const(4)
SPRITE_LASER_ORB = const(5)
SPRITE_LASER_WALL = const(6)
SPRITE_LASER_WALL_x2 = const(7)
SPRITE_LASER_WALL_POST = const(8)
SPRITE_WHITE_DOT = const(9)
SPRITE_HOLO_TRI = const(10)
