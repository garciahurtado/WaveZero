...
DEBUG_LED =                 const(0)
DEBUG_LOG_MEM =             const(0)
DEBUG_MEM =                 const(0)
DEBUG_PHYSICS =             const(0)
DEBUG_PIO =                 const(0)
DEBUG_PIXELS =              const(0)
DEBUG_POOL =                const(0)
DEBUG_PROFILER =            const(0)
...
IRQSUMMARY_PROC0_SECURE0 = IO_BANK0_BASE + 0x200
IRQSUMMARY_PROC0_SECURE1 = IO_BANK0_BASE + 0x204

IRQSUMMARY_PROC0_NONSECURE0 = IO_BANK0_BASE + 0x208
IRQSUMMARY_PROC0_NONSECURE1 = IO_BANK0_BASE + 0x20C
