...
class FramebufferPalette(fb.FrameBuffer):
    """
    ...
    def __init__(self, palette, color_mode=None):
        ...
        fb_color_mode = fb.RGB565 if self.color_mode in (self.BGR565, self.RGB565) else self.color_mode
    ...
    def set_hex(self, index, new_color):
